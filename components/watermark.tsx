...
const Watermark: React.FC<WatermarkProps> = ({ imageUrl }) => {
    return (
        <>
            <div
                className="fixed top-1/4 right-1/3 w-4/5 h-96 pointer-events-none z-[-1] opacity-30"
            >
                <Image
                    src={imageUrl}
                    alt="Watermark"
            ...
            <div
                className="absolute inset-x-0 -bottom-0 -z-10 transform-gpu overflow-hidden blur-2xl"
                aria-hidden="true"
            >
                <div
